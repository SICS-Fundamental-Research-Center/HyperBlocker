#ifndef HYPERBLOCKER_CORE_GPU_KERNEL_DATA_STRUCTURES_KERNEL_TABLE_CUH_
#define HYPERBLOCKER_CORE_GPU_KERNEL_DATA_STRUCTURES_KERNEL_TABLE_CUH_
...
public:
  ...
  __forceinline__ __device__ char *get_term_ptr(size_t col, size_t row) const {
...
#endif // HYPERBLOCKER_CORE_GPU_KERNEL_DATA_STRUCTURES_KERNEL_TABLE_CUH_
